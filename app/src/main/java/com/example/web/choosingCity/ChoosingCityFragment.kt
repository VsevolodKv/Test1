...
class ChoosingCityFragment : BaseFragment() {
    ...
    override fun onResume() {
        super.onResume()
        setTolBarTitle(R.string.choosing_city)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        chooseGomel.setOnClickListener {
            val bundle = Bundle()
            bundle.putString(TodayFragment.ARG_CITY_NAME, getString(R.string.Gomel))
        ...
        chooseMinsk.setOnClickListener {
            val bundle = Bundle()
            bundle.putString(TodayFragment.ARG_CITY_NAME, getString(R.string.Minsk))
        ...
        chooseBrest.setOnClickListener {
            val bundle = Bundle()
            bundle.putString(TodayFragment.ARG_CITY_NAME, getString(R.string.Brest))
        ...
        chooseGrodno.setOnClickListener {
            val bundle = Bundle()
            bundle.putString(TodayFragment.ARG_CITY_NAME, getString(R.string.Grodno))
        ...
        chooseMogilev.setOnClickListener {
            val bundle = Bundle()
            bundle.putString(TodayFragment.ARG_CITY_NAME, getString(R.string.Mogilev))
        ...
        chooseVitebsk.setOnClickListener {
            val bundle = Bundle()
            bundle.putString(TodayFragment.ARG_CITY_NAME, getString(R.string.Vitebsk))
            bundle.putDouble(TodayFragment.ARG_LAT, 39.9075000)
            bundle.putDouble(TodayFragment.ARG_LNG, 116.3972300)
            navController.navigate(R.id.fragment_today, bundle)
        }
